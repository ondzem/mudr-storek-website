/*
  # Fix timezone handling and prevent double bookings
  
  1. Changes
    - Set database timezone to Europe/Prague
    - Add trigger to prevent overlapping appointments
    - Add constraint for valid appointment times
    - Add index for faster appointment lookups
  
  2. Security
    - Ensure data integrity with constraints
    - Prevent double bookings with trigger
*/
